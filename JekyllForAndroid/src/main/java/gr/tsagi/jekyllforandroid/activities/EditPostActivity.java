...
//                return true;
    ...
    private void restorePreferences(){
        ...
        SharedPreferences mySharedPreferences = PreferenceManager.getDefaultSharedPreferences(EditPostActivity.this);
    ...
    private void publishPost(){
    	...
    	if(content.getText().toString().isEmpty())
    		Toast.makeText(EditPostActivity.this, R.string.newpost_empty, Toast.LENGTH_LONG).show();
    	else {
