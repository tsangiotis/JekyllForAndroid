...
public class SharedPref {
    ...
    public static final String FIRST_LAUNCH_KEY = "com.jchanghong.data.FIRST_LAUNCH_KEY";
    public static final String USER_NAME_KEY = "com.jchanghong.data.USER_NAME_KEY";
    public static final String NAME_EDIT_KEY = "com.jchanghong.data.NAME_EDIT_KEY";
